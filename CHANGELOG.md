...
### Added
- Check if there are several jsons with pattern report_*.json
- Added experiment path to output
### Fixed
### Changed
## v0.2.3 20251103

### Added
- Added flag -d (path to directory containing json)
- Added flag -j (path to json file)
### Fixed
### Changed
